...
class EstudianteAsignadoAdapter(
    ...
    inner class ViewHolder(private val binding: ItemEstudianteAsignadoBinding) :
        ...
        fun bind(student: Estudiante) {
            ...
            // Cargar las materias dinámicamente desde la tabla de inscripciones
            ...
            CoroutineScope(Dispatchers.IO).launch {
                ...
                // Mapear IDs de inscripciones a nombres de materias
                val materiasDelEstudiante: List<Materia> = todasLasMaterias.filter { m ->
